...
// }
// })
let current_users = ["TaHa", "DaNial", "SalMan", "Hamzah", "John"];
let new_users = ["Bilal", "Taha", "Dawood", "Jameel", "Hamzah"];
for (let i = 0; i < new_users.length; i++) {
    if (new_users[i] === "current_users") {
        console.log(`The username ${new_users} is not available.Please write a different usename`);
    }
    else {
